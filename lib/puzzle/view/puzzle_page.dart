...
import 'package:my_slide_puzzle/audio_control/audio_control.dart';
import 'package:my_slide_puzzle/dashatar/dashatar.dart';
import 'package:my_slide_puzzle/layout/layout.dart';
import 'package:my_slide_puzzle/models/models.dart';
import 'package:my_slide_puzzle/puzzle/puzzle.dart';
import 'package:my_slide_puzzle/simple/simple.dart';
import 'package:my_slide_puzzle/theme/theme.dart';
import 'package:my_slide_puzzle/timer/timer.dart';
    ...
    return ResponsiveLayoutBuilder(
      ...
      child: (currentSize) {
        ...
        return Padding(
          ...
          child: Tooltip(
            message:
                theme != currentTheme ? 'Changing the theme will reset your score' : '',
            child: TextButton(
